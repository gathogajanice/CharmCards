...
echo "🚀 Bitcoin Core Node Setup for Testnet4"
echo "======================================"
echo ""
...
echo ""
echo "⚠️  IMPORTANT: Save these credentials! You'll need them for your .env file."
echo ""

# Check if node is already running
if pgrep -x "bitcoind" > /dev/null; then
    echo "⚠️  Bitcoin Core is already running!"
...
echo ""
echo "📚 For more details, see: BITCOIN_CORE_SETUP.md"
echo ""
