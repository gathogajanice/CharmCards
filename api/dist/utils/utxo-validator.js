...
exports.validateUTXOFormat = validateUTXOFormat;
exports.validateUTXOExists = validateUTXOExists;
exports.validateUTXOValue = validateUTXOValue;
...
exports.validateInitialAmount = validateInitialAmount;
 ...
 */
function validateUTXOFormat(utxo) {
 ...
 */
async function validateUTXOExists(utxo) {
    ...
    try {
        ...
        const txResponse = await axios_1.default.get(txUrl, { timeout: 10000 });
        if (!txResponse.data) {
            return {
                valid: false,
        ...
        return {
            ...
            utxo: {
                txid: txid,
                vout: vout,
                value: Math.floor(value * 100000000), // Convert BTC to sats
                status: utxoStatus,
            },
        };
    }
 ...
 */
function validateUTXOValue(utxoValueSats, requiredSats) {
 ...
 */
function validateBitcoinAddress(address, network = 'testnet4') {
 ...
 */
function validateExpirationDate(expirationDate, defaultExpiration) {
